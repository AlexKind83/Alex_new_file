...
app = Flask(__name__)
app.config['SECRET_KEY'] = "fffggghhhjjjkkkllldddsssaaa"
...
@app.route("/profile/<username>")  # Динамическая часть пути.
def profile(username):
    return f'Пользователь: {username}'


# @app.route("/profile/<int:username>")  # часть пути будет только числовая
# def profile(username):
#     return f'Пользователь: {username}'
